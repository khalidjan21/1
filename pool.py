...
def _default_key_normalizer(
    ...
    :rtype:  PoolKey
    """
    # Since we mutate the dictionary
...
class PoolManager(RequestMethods):
    ...
    def _new_pool(
        ...
        # Although the context has everything necessary
    ...
    def connection_from_pool_key(
        ...
        with self.pools.lock:
            # If the scheme, host, or port doesn't match
    ...
    def urlopen(  # type: ignore[override]
        ...
        # conn.is_same_host() which may use socket.gethostbyname()
...
class ProxyManager(PoolManager):
    ...
    def urlopen(  # type: ignore[override]
        ...
        if not connection_requires_http_tunnel(self.proxy, self.proxy_config, u.scheme):
            ...
            # we'll definitely need to set host
